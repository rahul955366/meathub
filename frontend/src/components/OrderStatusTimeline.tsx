...
const statusMap: Record<string, { icon: any, label: string, color: string }> = {
    'PENDING': { icon: Clock, label: 'Order Sent to Butcher', color: 'slate' },
    'CONFIRMED': { icon: ShieldCheck, label: 'Butcher Confirmed Order', color: 'blue' },
    'PROCESSING': { icon: Package, label: 'Butcher is Packing your meat', color: 'amber' },
    'SHIPPED': { icon: Truck, label: 'Out for Delivery', color: 'indigo' },
    'DELIVERED': { icon: Check, label: 'Delivered Successfully', color: 'emerald' },
    'CANCELLED': { icon: Clock, label: 'Order Cancelled', color: 'red' }
};

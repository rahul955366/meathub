        ...
        <div className="w-full max-w-md mx-auto">
            ...
            <div className="text-center mb-10">
                ...
                <h2 className="text-4xl font-black tracking-tighter uppercase italic text-slate-900 mb-2">
                    {authMode === 'LOGIN' ? 'Sign In' : 'Join the Club'}
                </h2>
                <p className="text-slate-500 font-medium italic text-sm">
                    {authMode === 'LOGIN' ? 'Welcome back, meat expert!' : 'Ready to source the best cuts?'}
                </p>
            </div>
            ...
            >
                {authMode === 'LOGIN' ? "Don't have an account? Join the Club" : "Already a member? Sign In"}
            </button>
        </div>
    );
}

...
const STATUS_COLORS: Record<string, string> = {
    ...
    PROCESSING: 'bg-purple-500/20 text-purple-300', // Butcher is Packing
...
const TRANSITIONS: Record<string, { label: string; next: string; icon: React.ReactNode; color: string }[]> = {
    ...
    CONFIRMED: [{ label: 'Butcher is Packing', next: 'PROCESSING', icon: <Truck size={14} />, color: 'bg-purple-600 hover:bg-purple-500' }],
...
export default function ButcherOrders() {
    ...
    // C1: Poll for new pending orders every 30 seconds
    useEffect(() => {

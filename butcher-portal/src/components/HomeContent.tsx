...
export default function HomeContent({ initialItems = [], initialButchers = [] }: HomeContentProps) {
    return (
                ...
                <div className="container mx-auto px-4">
                    <div className="mb-12">
                        <div className="inline-flex items-center gap-2 bg-rose-50 border border-rose-100 px-4 py-2 rounded-full mb-4">
                            <span className="text-rose-600 text-xs font-black uppercase tracking-widest">Recommended</span>
                        </div>
                        <h3 className="text-4xl md:text-6xl font-black uppercase tracking-tighter italic text-slate-900 mb-3">
                            Trending <span className="text-rose-600 not-italic">Butcher Shops</span>
                        </h3>
                        <p className="text-slate-600 text-lg font-medium">Top-rated partners in your area</p>
                    </div>
                    <TrendingShops butchers={initialButchers} />
                </div>
            </section>

            {/* 5. TRENDING MEATS - PREMIUM */}

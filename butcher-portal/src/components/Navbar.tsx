            ...
            <nav className="fixed top-0 left-0 w-full z-50 bg-white/70 backdrop-blur-xl border-b border-slate-200">
                <div className="container mx-auto px-4 h-20 flex items-center justify-between">
                    ...
                    <div className="hidden md:flex items-center gap-10">
                        {[
                            { name: 'Dashboard', href: '/butcher/dashboard' },
                            { name: 'Orders', href: '/butcher/orders' },
                            { name: 'Inventory', href: '/butcher/inventory' },
                        ].map((link) => (
                            <Link
                                key={link.name}
                                href={link.href}
                    ...
                    <>
                        ...
                        >
                            <div className="space-y-8">
                                {[
                                    { name: 'Butcher Hub', href: '/butcher/dashboard' },
                                    { name: 'My Orders', href: '/butcher/orders' },
                                    { name: 'Inventory', href: '/butcher/inventory' },
                                ].map((link) => (
                                    <Link
                                        key={link.name}
